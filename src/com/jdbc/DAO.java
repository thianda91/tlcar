...
public class DAO {
	...
	/**
	 * 处理结果集, 得到 Map 的 List, Map 的 key 为 reusltSet 中列的别名, Map 的 value
	 * 
	 * @param clazz
	 *            类名
	 * @param lists
	 * @return 得到 Map 的 List ，其中一个 Map 对象就是一条记录
	 * @throws InstantiationException
	 * @throws IllegalAccessException
	 * @throws InvocationTargetException
	 */
	public static <T> List<T> transfterMapListToBeanList(Class<T> clazz,
			List<Map<String, Object>> lists) throws InstantiationException,
		...
		if (lists.size() > 0) {
			for (Map<String, Object> m : lists) {
				...
				for (Map.Entry<String, Object> entry : m.entrySet()) {
					String propertyName = entry.getKey().toLowerCase();// toLowerCase()
																		// NEEDED!!!
	 ...
	 * @throws SQLException
	 */
	public static List<Map<String, Object>> handleResultSetToMapList(ResultSet rs)
			throws SQLException {
	...
	/**
	 * 在 jdbc.properties 中读取已设的常量
	 * 
	 * @param getProperty
	 * @return
	 * @throws IOException
	 */
	public static String getProperty(String getProperty) throws IOException {
		Properties properties = new Properties();
		InputStream inStream = DAO.class.getClassLoader()
